...
Run `node cli.js history` before making that call. It reports the cached date range per Item and suggests the relink commands when the cache is shorter than the requested Link history.
